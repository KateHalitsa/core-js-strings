...
function extractNameFromTemplate(value) {
  const whitespace1 = value.indexOf(' ') + 1;
  const whitespace2 = value.indexOf(' ', whitespace1 + 1);
  const firstName = value.substring(whitespace1, whitespace2);
  const lastName = value.substring(whitespace2, value.length - 1);
